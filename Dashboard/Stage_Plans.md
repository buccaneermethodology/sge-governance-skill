...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SP-001 | SGE Governance Skill 历史迁移 | 将项目框架中的通用治理能力抽取为 SGE core，审计来源并清除产品污染，并通过通用性验收 | 建立可复用、可验证、与具体产品仓库隔离的治理基础设施 | S-001 → S-002 → S-003 → S-004 → S-005 → S-006 → S-012 | S-012 | Intake、Context、ERBE、Goal Conformance、lane cards、通用性测试、strategy provenance/canonical mapping、registry、SGC、独立 Validation、Semantic Review、closeout-language、post-closeout reconciliation | Doing | 在 S-012 通过后，声明本仓库 SGE Governance Skill 完成 active legacy 清理及有界通用性验收；不含具体产品实现、发布或普遍跨 repo 成熟性 | 现有迁移 closeout 不能覆盖新发现的 legacy；S-012 通过后再关闭 SP-001 |
