...
- [SP-003 Loop Goal](../Stage-Plan-SP-003/SP003_OpenSourceDistributionArchitecture_LoopGoal.md)：原始 mission、ODA-MH-01..12、连续执行与 completion rule。
- [SP-003 Stage Plan](../Stage-Plan-SP-003/SP003_OpenSourceDistributionArchitecture_StagePlan.md)：完整 MH ledger、S-016 至 S-022 DAG、S-016 exit criteria。
- [SP-003 Goal Contract](../Stage-Plan-SP-003/SP003_OpenSourceDistributionArchitecture_GoalContract.json)：原始 must-have、claim ceiling、Scope Delta registry、实现阶梯与最终审查要求。
