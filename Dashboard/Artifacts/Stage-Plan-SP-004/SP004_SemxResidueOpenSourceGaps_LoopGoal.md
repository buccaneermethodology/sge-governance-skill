...
- 原始范围：[Repository Capability Panorama 的“Semx 残留与开源缺口”](../Session-ADHOC-REPOSITORY-CAPABILITY-PANORAMA/RepositoryCapabilityPanorama.md#semx-残留与开源缺口)中的 10 项 Finding，逐项保留，不得以 SP-003 的有界完成或一次 grep/doctor 结果整体吸收。
...
- 用户指定源：[Repository Capability Panorama](../Session-ADHOC-REPOSITORY-CAPABILITY-PANORAMA/RepositoryCapabilityPanorama.md)及其[详细审计报告](../Session-ADHOC-REPOSITORY-CAPABILITY-PANORAMA/RepositoryCapabilityPanorama_Audit_Report.md)。
...
- 既有双仓边界：[SP-003 Loop Goal](../Stage-Plan-SP-003/SP003_OpenSourceDistributionArchitecture_LoopGoal.md)、[S-022 Closeout](../Stage-Plan-SP-003/SP003_S022_Closeout.md)。
