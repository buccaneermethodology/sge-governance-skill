...
| Finding 来源 | [Capability Panorama](../Session-ADHOC-REPOSITORY-CAPABILITY-PANORAMA/RepositoryCapabilityPanorama.md)、[Audit Report](../Session-ADHOC-REPOSITORY-CAPABILITY-PANORAMA/RepositoryCapabilityPanorama_Audit_Report.md) | 作为当前 finding inventory；不是批准或发布 authority |
...
| 相邻历史 | `Dashboard/Artifacts/Stage-Plan-SP-003/SP003_*` | 仅作为前置边界和历史证据；SP-003 有界结果不吸收本次 Finding |
