...
- Git inventory：写入本 artifact 前共有 41 个 untracked 文件，全部位于 `Dashboard/Artifacts/RepositoryCapabilityPanorama*`；写入后为 42 个。无 tracked、staged、renamed 或范围外变更。新增本 reconciliation 是 card 唯一允许写入。
