...
- 新增 [56 文件 Strategy Inventory](../Stage-Plan-SP-001/SP001_StrategySourceMigration_Inventory.md)。逐行重算汇总为 `migrate_after_refreeze=2`、`adapt_extract=26`、`reference_only=14`、`remove=14`。
- 新增 [SP-001 Goal Patch](../Stage-Plan-SP-001/SP001_StrategySourceExpansion_GoalPatch.md)，并把 `MH-11`、Session 分工和 Completion Rule 吸收进 resolved [Final Loop Goal](../Stage-Plan-SP-001/SP001_SGEGovernanceMigration_LoopGoal.md)与[迁移计划](../Stage-Plan-SP-001/SP001_SGEGovernanceMigration_Plan.md)。
...
- 当前仓库已删除历史产品文件；本轮仅保留[产品设计 locator](../Stage-Plan-SP-001/Tombstones/Removed_Audio_Transcriptor_Design.md)，未恢复其内容，也不声称来源产品可用。
...
| strategy 目录逐一查看 | 56 个源表面恰好一行，无遗漏/重复 | [Strategy Inventory](../Stage-Plan-SP-001/SP001_StrategySourceMigration_Inventory.md) | 20+22+14=56；逐行重算分类为 2/26/14/14，合计 56 | landed | 本轮仅初筛；S-002 必须复核 canonical mapping | 三个只读审计 lane→Orchestrator | 不构成迁移批准 | MH-11 与本 closeout 吸收 |
| 过滤 Semx 特定内容 | 每行明确可复用内容、排除内容和落点 | [Strategy Inventory](../Stage-Plan-SP-001/SP001_StrategySourceMigration_Inventory.md) | P00-P17、M1/P05/P06、KYM/TCO、Runtime/SAG ontology 与历史 IDs 被显式排除 | landed-as-adjudication | 目标仓库最终身份清理由 S-004 验收 | Read-only audit→S-004 | 不证明目标文件已删除 | MH-11/S-004 吸收 |
| 通用内容补入 SP-001 | MH、DAG、Plan、Completion Rule 一致更新 | [Goal Patch](../Stage-Plan-SP-001/SP001_StrategySourceExpansion_GoalPatch.md)、[Final Goal](../Stage-Plan-SP-001/SP001_SGEGovernanceMigration_LoopGoal.md)、[Plan](../Stage-Plan-SP-001/SP001_SGEGovernanceMigration_Plan.md) | 新增 MH-11；Completion 更新为 MH-01..11 | landed | 无删除或降级 | Human authority→Orchestrator | SP-001 仍未启动 | SP-001 parent 已吸收 |
...
S-002 必须把 [Strategy Inventory](../Stage-Plan-SP-001/SP001_StrategySourceMigration_Inventory.md)当作待复核 source manifest，而非迁移批准。每个候选都要追溯 canonical JSON、重新定义 SGE ontology/owner、做 duplication scan 和 ERBE applicability；找不到 canonical source 时不得直接 promotion。
