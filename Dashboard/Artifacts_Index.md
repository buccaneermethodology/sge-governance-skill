...
| [SP003_OpenSourceDistributionArchitecture_StagePlan.md](Artifacts/SP003_OpenSourceDistributionArchitecture_StagePlan.md) | SP-003 durable Stage Plan | 双仓开源分发架构的 S-016..S-022 DAG；当前 To do，不表示实现或发布 |
| [SP003_OpenSourceDistributionArchitecture_LoopGoal.md](Artifacts/SP003_OpenSourceDistributionArchitecture_LoopGoal.md) | SP-003 resolved reader-facing Loop Goal | 私有 canonical source、公开 bm-sge-governance projection、维护者/用户路径、权限与 release 边界 |
| [SP003_OpenSourceDistributionArchitecture_GoalPatch.md](Artifacts/SP003_OpenSourceDistributionArchitecture_GoalPatch.md) | SP003-GP-001 Goal Patch | 将 Stage Plan 解析为完整实现阶梯；Scope Delta=none |
| [SP003_OpenSourceDistributionArchitecture_GoalContract.json](Artifacts/SP003_OpenSourceDistributionArchitecture_GoalContract.json) | goal_contract_v1 machine contract | ODA-MH-01..12、claim ceiling、completion rule、identity、DAG 与边界 |
| [SP003_OpenSourceDistributionArchitecture_GoalContextBootstrap.json](Artifacts/SP003_OpenSourceDistributionArchitecture_GoalContextBootstrap.json) | SP-003 Goal design Context Bootstrap | 用户原始目标、Required Read Set、影响面、跳过远端读写与 validation surfaces |
| [SP003_OpenSourceDistributionArchitecture_GoalDesign_Closeout.md](Artifacts/SP003_OpenSourceDistributionArchitecture_GoalDesign_Closeout.md) | SP-003 Goal design 中文 closeout | 只证明设计和执行入口落库；不声明实现、public repo 或 release |
| [SP003_OpenSourceDistributionArchitecture_NameRevision_Closeout.md](Artifacts/SP003_OpenSourceDistributionArchitecture_NameRevision_Closeout.md) | SP-003 公开仓名称修订 closeout | 记录 `sge-governance` → `bm-sge-governance` 的 Goal/合同/KB/Dashboard 重绑定；不证明 GitHub 仓库已创建 |
...
| [SGEGovernanceRepositoryExtraction_Closeout.md](Artifacts/SGEGovernanceRepositoryExtraction_Closeout.md) | SGE Governance 专用仓库整理收束 | 删除具体产品源文件，保留通用 Skill；quick_validate 后续在依赖可用环境补跑 |
